...
<head>
        ...
        <meta name="author" content="Keyborad Crackers" />
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <div class="login-box">
                                <a href="./" class="logo-name text-lg text-center">Agri Connect</a>
                                ...
                                <form class="m-t-md" action="pages/authentication.php" method="POST">
                                    ...
                                    <a href="register.php" class="display-block text-center m-t-md text-sm">New Registration</a>
                                </form>
